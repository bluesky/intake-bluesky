...
def pages_to_xarray(*, start_doc, stop_doc, descriptor_docs, get_eventpage_cursor,
                        filler, get_resource, get_datumpage_cursor,
    ...
    for descriptor in descriptor_docs:
        events = get_eventpage_cursor(descriptor)
